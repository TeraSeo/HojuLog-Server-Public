...
public interface WorldCupPostService {
    ...
    Page<WorldCupPost> getCreatedAtDescPostsByPage(Pageable pageable, String option);

    Page<WorldCupPost> getCreatedAtDescPostsByPageNSubCategory(SubCategory subCategory, Pageable pageable, String option);
